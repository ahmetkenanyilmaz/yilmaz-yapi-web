    ...
    <SiteLayout currentPath="/iletisim">
      <section className="bg-cream py-12 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-8">
              ...
              <ContactInfoBlock
                ...
                content={
                  <div className="space-y-1">
                    <a
                      href={primary.href}
                      className="block font-medium text-charcoal transition-colors duration-[250ms] ease-in-out hover:text-[#B8934A]"
                    >
                      {primary.number} - {primary.name}
                    </a>
                    <a
                      href={secondary.href}
                      className="block text-muted transition-colors duration-[250ms] ease-in-out hover:text-charcoal"
                    >
                      {secondary.number} - {secondary.name}
                    </a>
                  </div>
                }
              />
              ...
              <ContactInfoBlock
                ...
                content={
                  <a
                    href={`mailto:${siteConfig.email}`}
                    className="transition-colors duration-[250ms] ease-in-out hover:text-charcoal"
                  >
                    {siteConfig.email}
                  </a>
                }
          ...
          <div className="mt-12 overflow-hidden border border-[#ede9e1]">
            <iframe
...
function ContactInfoBlock({
  ...
  href?: string;
  iconHover?: "none" | "gold" | "whatsapp" | "instagram";
}) {
  const hoverClass =
    iconHover === "gold"
      ? "hover:bg-[#B8934A]"
  ...
  const iconEl = (
    <span className={`${iconCircle} ${hoverClass}`}>{icon}</span>
  );
  ...
  return (
    <div className="flex gap-4">
      ...
      <div>
        <p className="text-xs font-semibold uppercase tracking-wider text-[#B8934A]">
          {title}
        </p>
