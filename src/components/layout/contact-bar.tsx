...
export function ContactBar() {
  const [primary] = siteConfig.phones;

  return (
    <section className="border-t border-cream-dark bg-cream">
      <div className="mx-auto grid max-w-7xl grid-cols-1 divide-y divide-cream-dark sm:grid-cols-3 sm:divide-x sm:divide-y-0">
        <ContactItem
          icon={<PhoneIcon />}
...
function ContactItem({
  ...
  const className =
    "flex items-center gap-4 px-6 py-6 transition-colors hover:bg-cream sm:px-8";
